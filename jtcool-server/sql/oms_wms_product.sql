...
DROP TABLE IF EXISTS wms_stock_statistics CASCADE;
DROP TABLE IF EXISTS wms_inventory_log CASCADE;
DROP TABLE IF EXISTS wms_stock_bill_item CASCADE;
DROP TABLE IF EXISTS wms_stock_bill CASCADE;
DROP TABLE IF EXISTS wms_inventory CASCADE;
DROP TABLE IF EXISTS wms_shelf CASCADE;
DROP TABLE IF EXISTS wms_location CASCADE;
DROP TABLE IF EXISTS wms_area CASCADE;
DROP TABLE IF EXISTS wms_warehouse CASCADE;

DROP TABLE IF EXISTS oms_order_statistics CASCADE;
DROP TABLE IF EXISTS oms_payment CASCADE;
DROP TABLE IF EXISTS oms_finance CASCADE;
DROP TABLE IF EXISTS oms_order_flow CASCADE;
DROP TABLE IF EXISTS oms_order_item CASCADE;
DROP TABLE IF EXISTS oms_order CASCADE;
DROP TABLE IF EXISTS oms_customer CASCADE;

DROP TABLE IF EXISTS prd_product CASCADE;
DROP TABLE IF EXISTS prd_supplier CASCADE;
DROP TABLE IF EXISTS prd_brand CASCADE;
DROP TABLE IF EXISTS prd_category CASCADE;
